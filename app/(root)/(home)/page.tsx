...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full bg-black bg-dot-white/[0.2] relative flex items-center justify-center h-screen">
        <div className="absolute pointer-events-none inset-0 flex items-center justify-center bg-black [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>

        <div className="relative overflow-hidden h-screen mt-0 sm:mt-0">
          <div className="max-w-[95rem] sm:max-w-[125rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
            <div className="text-center">
              <h1 className="text-4xl sm:text-6xl font-bold text-neutral-200">
                Lingua <span className="text-[#B02DD4]">AI</span>
              </h1>
              <p className="mt-3 text-neutral-400">
                LinguaAI: Speak Freely, Connect Globally.
              </p>
